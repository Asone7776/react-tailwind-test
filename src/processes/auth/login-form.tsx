...
import {
  LoginFormFields,
  LoginSchema,
} from '@features/auth/login/model/validation.ts';
      ...
      <div className="grid gap-6">
        <div className="grid gap-2">
          ...
          {errors?.email?.message && (
            <ValidationAlert>{errors.email.message}</ValidationAlert>
          )}
        </div>
        <div className="grid gap-2">
          ...
          {errors?.password?.message && (
            <ValidationAlert>{errors.password.message}</ValidationAlert>
          )}
        </div>
        <DefaultButton
          disabled={loading}
