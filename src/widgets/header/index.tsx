...
export default function Index() {
    ...
    return (
        <header className={cn('fixed w-full z-10 transition-colors', moved ? 'bg-indigo-200' : 'bg-white')}>
            <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
                ...
                <PopoverGroup className="hidden lg:flex lg:gap-x-12">
                    <Popover className="relative">
                        <PopoverButton className="text-sm/6 font-semibold text-gray-900 outline-0 cursor-pointer flex">
                            Product
                            <ChevronDownIcon aria-hidden="true"
                                             className={cn('size-5 ml-2 flex-none', moved ? 'text-white' : 'text-indigo-200')}/>
                        </PopoverButton>
                            ...
                            <div className="space-y-2 py-6">
                                <Disclosure as="div" className="-mx-3">
                                    <DisclosureButton
                                        ...
                                        Product
                                        <ChevronDownIcon aria-hidden="true"
                                                         className="size-8 flex-none group-data-open:rotate-180"/>
                                    </DisclosureButton>
