...
export default function ContactUs() {
    ...
    const handleChangeField = (key: string, value: string | boolean | undefined) => {
        setValues((values) => ({
            ...values,
            [key]: value
        }));
        ...
        <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Contact
                    sales</h2>
                <p className="mt-2 text-lg/8 text-gray-600">Aute magna irure deserunt veniam aliqua magna enim
                    voluptate.</p>
            </div>
            <form onSubmit={onSubmit} className="mx-auto mt-16 max-w-xl sm:mt-20">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-2.5">
                            <input
                                ...
                                onChange={(event) => handleChangeField('companyName', event.target.value)}
                    ...
                    <Field className="flex gap-x-4 sm:col-span-2">
                        <div className="flex h-6 items-center">
                            <Switch
                                ...
                                onChange={(val) => handleChangeField('agreed', val)}
                ...
                <div className="mt-10">
                    <DefaultButton type={ButtonTypes.submit} disabled={loading} loading={loading}/>
                </div>
            </form>
        </div>
    )
