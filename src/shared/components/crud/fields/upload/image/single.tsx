    ...
    <div>
      ...
      <Controller
        ...
        render={({ field }) => (
          <>
            {preview ? (
              <div className="mt-2 relative flex-center rounded-md border-2 max-w-[150px] min-w-[150px] h-[150px] overflow-hidden">
                <div
                  className={
                    'absolute top-0 right-0 rounded-md bg-primary p-1 cursor-pointer'
                  }
                  onClick={deleteImage}
                >
              ...
              <div
                className={
                  'rounded-md border-2 flex justify-center items-center p-4 cursor-pointer bg-primary w-full max-w-[150px] h-[150px]'
                }
                onClick={handleClick}
              >
